          ...
          <div className="card mb-3 mx-auto bg-dark text-light">
            <div className="row g-0">
              <div className="col-md-4">
                ...
                <img
                  src="https://images.pexels.com/photos/10817264/pexels-photo-10817264.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
              ...
              <div className="col-md-8">
                <div className="card-body text-start mt-2">
                  ...
                  <h5 className="card-text">
                    Sensación térmica:{" "}
                    {(weather.main.feels_like - 273.15).toFixed(2)}ºC
                  </h5>
                  <h5 className="card-text">
